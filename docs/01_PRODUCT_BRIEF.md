...
- 最高缩放提高到 `1000%`；`500%` 是精细交互起点，详细层级、地标横幅和交互阈值以 `04_MAP_AND_ART_DIRECTION.md` 为准。
