...
9. `100—477` 地标不可点击且悬停只亮街区，地块/开发建筑/地标横幅不开放；`500—1500` 时地块和地标可点击，开发建筑出现；`1250—1500` 时地标横幅与插画共同高亮。
