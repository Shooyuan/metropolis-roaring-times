...
- Far and middle zoom keep historical-landmark illustrations visible for recognition, hide development-building illustrations, and show a district summary in this exact order: human-purchasable plots, human-owned apartments, human-owned factories, human-owned department stores, major transit facilities, district prosperity. Landmark map banners stay hidden at every zoom by owner decision.
- `100%—477%` remains district-oriented browsing: landmark illustrations stay visible for recognition, while plot/landmark selection and development-building illustrations remain disabled. From `500%` through the `1500%` maximum, plot boundaries, development-building illustrations and plot/landmark selection remain enabled. Landmark map banners are hidden by owner decision; landmark names and copy appear in the right-side Historical File instead. Landmark hover and selection use a red glow on the transparent landmark artwork only; no full rectangular image-frame border is permitted. Purchasable plot borders use the thinner M1W treatment approved on 2026-09-12.
