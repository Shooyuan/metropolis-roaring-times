...
const staticText = {
  "NEW YORK PROPERTY EXCHANGE · MANHATTAN EDITION": "纽约地产交易所 · 曼哈顿版",
  ...
  "Each buy or sell uses 1 of the existing 3 action points. Minimum order $1,000; fee 1%.": "每次买入或卖出消耗现有 3 点行动点中的 1 点。最低委托额 $1,000，手续费 1%。", "Order value": "委托金额", "These baskets are fictional aggregate instruments. Futures, short selling, broker margin and live prices are unavailable.": "这些证券篮子是虚构的综合投资标的，不提供期货、做空、融资融券或实时行情。",
