...
const zhCN = {
  ...
  "district.district_west_village.name": "西村", "district.district_west_village.label": "西村", "district.district_west_village.location": "下西区", "district.district_west_village.note": "M1W 地图中已批准的格林尼治村西部分区。",
  "district.district_east_village.name": "东村", "district.district_east_village.label": "东村", "district.district_east_village.location": "下东区", "district.district_east_village.note": "M1W 地图中已批准的格林尼治村东部分区。",
  ...
  "plot.cp_01.name": "河滨高地", "plot.cp_02.name": "博物馆街区", "plot.cp_public.name": "中央公园", "plot.uw_01.name": "西区街廓", "plot.ue_01.name": "东区庭院", "plot.mt_01.name": "服装业广场", "plot.mt_02.name": "中央大道", "plot.hk_01.name": "西部铁路场", "plot.mt_03.name": "先驱广场街廓", "plot.les_01.name": "果园街庭院", "plot.hk_02.name": "铸造厂巷", "plot.les_02.name": "埃塞克斯市场", "plot.lm_01.name": "市政交易所", "plot.lm_public.name": "市政厅", "plot.lm_02.name": "华尔街街角", "plot.lm_03.name": "炮台仓库", "plot.bb_01.name": "大桥登陆点", "plot.bb_02.name": "码头地块", "plot.unmapped_fixture": "未映射的 M0 固定数据",
  ...
  "map.hover_lock": "悬停查看分区 · 单击锁定", "map.selection_locked": "{district} · 已锁定选择", "map.open_file": "{district} · 单击打开分区档案", "map.press_enter": "{district} · 按 Enter 键选择", "map.status": "{count} 个分区 · 老板定稿几何", "map.load_error": "无法准备正式地图，请检查本地 HTTP 服务器和素材文件。", "map.load_failed": "地图载入失败", "map.unavailable": "正式地图不可用",
  "aria.select_district": "选择{district}", "aria.plot": "{plot}，{owner}，{building}",
...
const staticText = {
  "M1W PRODUCER MAP DEMO — FIGMA MAP INTEGRATION · NOT FINAL PLOTS OR BALANCE": "M1W 制作人地图演示 — FIGMA 地图集成 · 非最终地块与数值平衡",
  ...
  "Buy and develop property for operating income.": "购买并开发地产，获得经营收入。", "Redevelop upward when a better legal use appears.": "出现更优且合法的用途时，向上改建建筑。", "Use sales, banking and securities to manage liquidity.": "通过出售、银行和证券管理流动性。", "Finish turn 8 with the highest net worth.": "在第 8 回合结束时取得最高净资产。", "This build validates the owner-authored 12-district map. The 64 production plots and 20-turn balance remain a later approval gate.": "此版本用于验证老板绘制的 12 分区地图。64 个正式地块与 20 回合数值平衡仍需后续审批。",
  ...
  "Manhattan District Map": "曼哈顿分区地图", "Loading official map…": "正在载入正式地图…", "Preparing owner-authored vector map…": "正在准备老板绘制的矢量地图…", "DRAG TO PAN · SCROLL OR USE CONTROLS TO ZOOM · NO ROTATION": "拖动平移 · 滚轮或按钮缩放 · 不可旋转", "Reset View": "重置视图", "12 districts · Owner geometry": "12 个分区 · 老板定稿几何", "District hit area": "分区感应区", "Hover border": "悬停边框", "Locked selection": "已锁定选择",
  "District File": "分区档案", "Select a district": "请选择分区", "Hover the map to reveal its boundary. Click once to lock the border and open this file.": "将鼠标移到地图上即可显示边界，单击可锁定边框并打开该分区档案。", "Manhattan, New York": "纽约 · 曼哈顿", "Available Plots": "可购入地块", "Pending": "待定", "Your Apartments": "你的公寓", "Your Factories": "你的工厂", "Your Stores": "你的商场", "Major Transit": "大型交通设施", "Prosperity": "繁荣度", "M1W map scope": "M1W 地图范围", "Geometry and selection are under review. Gameplay figures wait for the approved 64-plot dataset.": "几何边界与选择交互正在审核。玩法数据等待批准后的 64 地块数据集。", "Source: owner-authored Figma handoff v003.": "来源：老板绘制的 Figma 交付包 v003。",
  "Select a plot on the map.": "请在地图上选择地块。", "District": "分区", "Zone": "用途", "Owner": "业主", "Building": "建筑", "Income": "收入", "Buy Plot": "购买地块", "Build on owned empty land": "在自有空地上建造", "Standard Apartment — $8,000": "标准公寓 — $8,000", "Factory — $15,000": "工厂 — $15,000", "Luxury Apartment — $25,000": "豪华公寓 — $25,000", "Department Store — $30,000": "百货商场 — $30,000", "Build": "建造", "Redevelop into a higher-cost building": "改建为成本更高的建筑", "Redevelop": "改建", "Brokered Sale": "经纪出售",
