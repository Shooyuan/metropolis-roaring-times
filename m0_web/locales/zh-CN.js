...
const zhCN = {
  ...
  "confirm.title": "确认指令", "confirm.cancel": "取消", "confirm.ok": "确认",
...
const staticText = {
  ...
  "Mode": "模式", "1v1": "1v1", "Ruleset": "规则", "Standard": "标准", "Rival": "对手", "Style": "风格", "Condition": "状态", "Rival Worth": "对手净资产", "Current Law": "当前法令", "Objective": "目标", "Lead after turn 30": "第 30 回合结束时领先",
  "Buy and develop property for operating income.": "购买并开发地产，获得经营收入。", "Redevelop upward when a better legal use appears.": "出现更优且合法的用途时，向上改建建筑。", "Use sales, banking and securities to manage liquidity.": "通过出售、银行和证券管理流动性。", "Finish turn 30 with the highest net worth.": "在第 30 回合结束时取得最高净资产。", "Explore 12 districts, 30 purchasable plots and 52 historical landmarks across Manhattan.": "探索曼哈顿的 12 个街区、30 个可购地块与 52 处历史地标。",
