...
const staticText = {
  ...
  "Buy and develop property for operating income.": "购买并开发地产，获得经营收入。", "Redevelop upward when a better legal use appears.": "出现更优且合法的用途时，向上改建建筑。", "Use sales, banking and securities to manage liquidity.": "通过出售、银行和证券管理流动性。", "Finish turn 8 with the highest net worth.": "在第 8 回合结束时取得最高净资产。", "This build validates the owner-authored 12-district map. The production plot set and 20-turn balance remain a later approval gate.": "此版本用于验证老板绘制的 12 街区地图。正式地块集合与 20 回合数值平衡仍需后续审批。",
