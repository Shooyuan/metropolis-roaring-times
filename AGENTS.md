...
2. 当前垂直切片严格遵守 `00_PROJECT_CONTEXT.md`。`docs/01_PRODUCT_BRIEF.md` 至 `docs/07_IMPLEMENTATION_PLAN.md` 以及对应专项规范（包括 `docs/MAP_ASSET_PIPELINE.md`）是已经与总纲贯通的实施规格；任何后续范围变更都必须同时更新总纲、规则、范围、架构、验收、计划和受影响的专项规范，不得只改其中一份。
